...
var rosbridgesResource = schema.GroupVersionResource{Group: "roboscale.io", Version: "v1alpha1", Resource: "rosbridges"}

var rosbridgesKind = schema.GroupVersionKind{Group: "roboscale.io", Version: "v1alpha1", Kind: "ROSBridge"}
...
func (c *FakeROSBridges) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ROSBridge, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(rosbridgesResource, c.ns, name), &v1alpha1.ROSBridge{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ROSBridge), err
}
...
func (c *FakeROSBridges) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ROSBridgeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(rosbridgesResource, rosbridgesKind, c.ns, opts), &v1alpha1.ROSBridgeList{})
	...
	list := &v1alpha1.ROSBridgeList{ListMeta: obj.(*v1alpha1.ROSBridgeList).ListMeta}
	for _, item := range obj.(*v1alpha1.ROSBridgeList).Items {
...
func (c *FakeROSBridges) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(rosbridgesResource, c.ns, opts))
...
func (c *FakeROSBridges) Create(ctx context.Context, rOSBridge *v1alpha1.ROSBridge, opts v1.CreateOptions) (result *v1alpha1.ROSBridge, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(rosbridgesResource, c.ns, rOSBridge), &v1alpha1.ROSBridge{})
...
func (c *FakeROSBridges) Update(ctx context.Context, rOSBridge *v1alpha1.ROSBridge, opts v1.UpdateOptions) (result *v1alpha1.ROSBridge, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(rosbridgesResource, c.ns, rOSBridge), &v1alpha1.ROSBridge{})
...
func (c *FakeROSBridges) UpdateStatus(ctx context.Context, rOSBridge *v1alpha1.ROSBridge, opts v1.UpdateOptions) (*v1alpha1.ROSBridge, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(rosbridgesResource, "status", c.ns, rOSBridge), &v1alpha1.ROSBridge{})
...
func (c *FakeROSBridges) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(rosbridgesResource, c.ns, name, opts), &v1alpha1.ROSBridge{})
...
func (c *FakeROSBridges) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(rosbridgesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.ROSBridgeList{})
	return err
}
...
func (c *FakeROSBridges) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ROSBridge, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(rosbridgesResource, c.ns, name, pt, data, subresources...), &v1alpha1.ROSBridge{})
