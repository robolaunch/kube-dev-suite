...
var buildmanagersResource = schema.GroupVersionResource{Group: "roboscale.io", Version: "v1alpha1", Resource: "buildmanagers"}

var buildmanagersKind = schema.GroupVersionKind{Group: "roboscale.io", Version: "v1alpha1", Kind: "BuildManager"}
...
func (c *FakeBuildManagers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BuildManager, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(buildmanagersResource, c.ns, name), &v1alpha1.BuildManager{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.BuildManager), err
}
...
func (c *FakeBuildManagers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BuildManagerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(buildmanagersResource, buildmanagersKind, c.ns, opts), &v1alpha1.BuildManagerList{})
	...
	list := &v1alpha1.BuildManagerList{ListMeta: obj.(*v1alpha1.BuildManagerList).ListMeta}
	for _, item := range obj.(*v1alpha1.BuildManagerList).Items {
...
func (c *FakeBuildManagers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(buildmanagersResource, c.ns, opts))
...
func (c *FakeBuildManagers) Create(ctx context.Context, buildManager *v1alpha1.BuildManager, opts v1.CreateOptions) (result *v1alpha1.BuildManager, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(buildmanagersResource, c.ns, buildManager), &v1alpha1.BuildManager{})
...
func (c *FakeBuildManagers) Update(ctx context.Context, buildManager *v1alpha1.BuildManager, opts v1.UpdateOptions) (result *v1alpha1.BuildManager, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(buildmanagersResource, c.ns, buildManager), &v1alpha1.BuildManager{})
...
func (c *FakeBuildManagers) UpdateStatus(ctx context.Context, buildManager *v1alpha1.BuildManager, opts v1.UpdateOptions) (*v1alpha1.BuildManager, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(buildmanagersResource, "status", c.ns, buildManager), &v1alpha1.BuildManager{})
...
func (c *FakeBuildManagers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(buildmanagersResource, c.ns, name, opts), &v1alpha1.BuildManager{})
...
func (c *FakeBuildManagers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(buildmanagersResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.BuildManagerList{})
	return err
}
...
func (c *FakeBuildManagers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BuildManager, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(buildmanagersResource, c.ns, name, pt, data, subresources...), &v1alpha1.BuildManager{})
