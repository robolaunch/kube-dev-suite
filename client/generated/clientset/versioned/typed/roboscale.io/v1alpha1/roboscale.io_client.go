...
import (
	...
	"github.com/robolaunch/kube-dev-suite/client/generated/clientset/versioned/scheme"
...
// NewForConfigAndClient creates a new RoboscaleV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*RoboscaleV1alpha1Client, error) {
	...
	return &RoboscaleV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new RoboscaleV1alpha1Client for the given config and
...
func New(c rest.Interface) *RoboscaleV1alpha1Client {
	return &RoboscaleV1alpha1Client{c}
}
